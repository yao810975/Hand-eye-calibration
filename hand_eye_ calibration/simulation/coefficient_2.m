...
% p_e = Tb_e*Te_c*p_c
% p_e = Te_b*Tb_c*p_c
% The constant coefficient of solution 2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INPUT
...
% OUTPUT
% k        :  - Constant coefficient in x direction 
% m        :  - Constant coefficient in y direction 
% w        :  - Constant coefficient in z direction 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  p_e_x = nx/f1y
%  nx = (k1*Tdy + k2)*cos(thetaz)^2+(k3*Tdy + k4)*cos(thetaz)+(k5*Tdy + k6)*sin(thetaz)^2 + (k7*Tdy + k8)*sin(thetaz)
%  dx = f1y
